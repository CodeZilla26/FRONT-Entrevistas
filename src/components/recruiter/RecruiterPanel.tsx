      ...
      <div className="w-full h-full relative">
        ...
        {interviewsHook.showCreateInterviewModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/30 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-bold text-slate-100">Nueva Entrevista</h3>
                <button 
              ...
              <form onSubmit={interviewsHook.handleCreateInterview} className="space-y-6">
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe el propósito y enfoque de esta entrevista..."
                    required
                  />
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 disabled:opacity-50"
                  >
                    {interviewsHook.isCreatingInterview ? 'Creando...' : 'Crear Entrevista'}
                  </button>
                </div>
              </form>
            </div>
