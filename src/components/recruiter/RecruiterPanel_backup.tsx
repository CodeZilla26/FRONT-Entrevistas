...
export const RecruiterPanel = ({ activeTab, onShowToast }: RecruiterPanelProps) => {
  ...
  // Renderizar tab de entrevistas (implementación futura)
    ...
    return (
      <div className="w-full h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-slate-100 mb-2">Tab de Entrevistas</h3>
          <p className="text-slate-400">Componente en desarrollo...</p>
          <p className="text-slate-500 text-sm mt-2">
            Los hooks y servicios están listos. Solo falta crear los componentes UI.
          </p>
        </div>
      </div>
    );
  ...
  // Renderizar tab de resultados (implementación futura)
    ...
    return (
      <div className="w-full h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-slate-100 mb-2">Tab de Resultados</h3>
          <p className="text-slate-400">Componente en desarrollo...</p>
          <p className="text-slate-500 text-sm mt-2">
            Los hooks y servicios están listos. Solo falta crear los componentes UI.
          </p>
    ...
    return (
      <div className="w-full h-full relative">
        ...
        <div className="relative p-8">
          ...
          <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/30 rounded-2xl p-8 mb-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center space-x-6">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-slate-100 mb-2">Dashboard de Participantes</h2>
                  <p className="text-slate-400 text-lg">Gestiona y supervisa todos los participantes del proceso</p>
                  {/* Status indicator like sidebar */}
              ...
              <button
                ...
                className="bg-gradient-to-r from-indigo-600/80 to-purple-600/80 hover:from-indigo-700/90 hover:to-purple-700/90 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg backdrop-blur-sm border border-indigo-500/30 hover:shadow-indigo-500/25 hover:shadow-xl hover:scale-105 flex items-center space-x-3"
              >
          ...
          {/* Statistics Cards with sidebar-style design */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/30 rounded-2xl p-6 shadow-2xl relative overflow-hidden hover:shadow-indigo-500/10 transition-all duration-300 hover:scale-105">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-transparent pointer-events-none"></div>
              <div className="relative flex items-center justify-between">
                <div>
                  <p className="text-slate-400 text-sm font-medium mb-1">Total Participantes</p>
                  <p className="text-3xl font-bold text-indigo-400">{participants.length}</p>
                  <div className="flex items-center mt-2">
                    <div className="w-1.5 h-1.5 bg-indigo-400 rounded-full animate-pulse"></div>
                    <span className="text-xs text-indigo-300 ml-2">Registrados</span>
                  </div>
                </div>
                <div className="bg-gradient-to-br from-indigo-500/20 to-indigo-600/10 p-4 rounded-xl border border-indigo-500/20">
                  <Users className="w-8 h-8 text-indigo-400" />
                </div>
              </div>
            </div>
            
            <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/30 rounded-2xl p-6 shadow-2xl relative overflow-hidden hover:shadow-green-500/10 transition-all duration-300 hover:scale-105">
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-transparent pointer-events-none"></div>
              <div className="relative flex items-center justify-between">
                <div>
                  <p className="text-slate-400 text-sm font-medium mb-1">Entrevistas Completas</p>
                  <p className="text-3xl font-bold text-green-400">
                    {participants.filter(p => p.status === 'Entrevista Completa').length}
                  </p>
                  <div className="flex items-center mt-2">
                    <div className="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-xs text-green-300 ml-2">Finalizadas</span>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/30 rounded-2xl p-6 shadow-2xl relative overflow-hidden hover:shadow-yellow-500/10 transition-all duration-300 hover:scale-105">
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/10 to-transparent pointer-events-none"></div>
              <div className="relative flex items-center justify-between">
                <div>
                  <p className="text-slate-400 text-sm font-medium mb-1">En Proceso</p>
                  <p className="text-3xl font-bold text-yellow-400">
                    {participants.filter(p => p.status === 'En Proceso').length}
                  </p>
                  <div className="flex items-center mt-2">
                    <div className="w-1.5 h-1.5 bg-yellow-400 rounded-full animate-pulse"></div>
                    <span className="text-xs text-yellow-300 ml-2">Activas</span>
                  </div>
                </div>
          ...
          {/* Participants List with Filters - Enhanced design */}
          <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/30 shadow-2xl rounded-2xl overflow-hidden relative">
            {/* Decorative overlays */}
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-transparent to-purple-500/5 pointer-events-none"></div>
            {/* Header with Search and Filters - Enhanced */}
          ...
          {/* Content */}
          <div className="relative p-6 overflow-y-auto custom-scroll-green max-h-96">
                ...
                {viewMode === 'grid' && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    {filteredAndSortedParticipants().map((participant, index) => (
                      <div
                        key={participant.id}
                        className="group relative bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/30 rounded-2xl p-6 shadow-2xl hover:border-indigo-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/25 hover:-translate-y-1 overflow-hidden"
                      >
                        {/* Decorative overlays like sidebar */}
                        <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-transparent to-purple-500/5 pointer-events-none"></div>
                        ...
                        {/* Avatar with sidebar-style design */}
                        ...
                        {/* Actions with sidebar-style design */}
              ...
              <div className="bg-slate-700/50 p-4 rounded-xl mb-6">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold">
                    {selectedParticipant?.name?.charAt(0)?.toUpperCase() || 'U'}
                  </div>
                  <div>
                    <h4 className="text-slate-100 font-semibold">{selectedParticipant?.name || 'Usuario'}</h4>
                    <p className="text-slate-400 text-sm">{selectedParticipant?.email || 'Sin email'}</p>
                  </div>
                </div>
              </div>
