                    ...
                    <div key={index} className="group hover:bg-slate-700/20 transition-all duration-300 rounded-xl p-5 border border-slate-600/20 hover:border-slate-500/40">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-shrink-0 text-center">
                          <div className="w-12 h-12 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-xl flex items-center justify-center mb-2 border border-indigo-500/30"></div>
