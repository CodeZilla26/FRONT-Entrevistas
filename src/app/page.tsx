...
export default function Home() {
  // Silenciar logs en cliente para esta app (log, warn, info, error)
  // Se ejecuta en montaje del componente de página y aplica globalmente en el navegador
  if (typeof window !== 'undefined') {
    ...
    // eslint-disable-next-line no-console
    console.info = (() => {}) as any;
    // Mantener console.error para ver errores reales en cliente
  }
